...
class UtmConverter {
  ...
  late final double _e3;
  late final double _eP2;

  late final double _sqrtE;
  late final double __e;
  late final double __e2;
  late final double __e3;
  late final double __e4;
  late final double __e5;

  late final double _m1;
  late final double _m2;
  late final double _m3;
  late final double _m4;

  late final double _p2;
  late final double _p3;
  late final double _p4;
  late final double _p5;
  ...
  UtmCoordinate utmToLatLon(
    ...
    final northern = zoneLetter.toUpperCase().codeUnitAt(0) >= 'N'.codeUnitAt(0);
